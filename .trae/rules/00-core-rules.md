...
## 项目定位
番茄小说 AI 创作辅助系统 v8.1，当前作品《末日模拟器》5卷300章。

AI 可生成正文参考/草稿，但**必须通过质量门禁（S3 多维度评审 / dimension scoring）**。
- 通过门禁的 AI 内容可作为作者参考或直接采用；
- 未通过门禁的 AI 内容必须由作者手写替代；
- 最终判定标准是质量门禁分数与作者审核，而非字数限制。

历史约束“禁止生成 >30 字连续小说正文”已废止，以本段质量门禁机制为准。
