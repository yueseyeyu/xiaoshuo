...
| ② 拆书 | `rhythm_analyzer` | 逐章35+指标：爽点/钩子/冲突/节奏/可读性/反套路/情绪价值 | Group 2 |
...
> v7.6 并发管线：阶段 ②③⑥ 通过 ThreadPoolExecutor 并行执行，总耗时减少约 40%。
...
| 目录 | 用途 |
|------|------|
| `src/xiaoshuo/pipeline/` | 数据分析管线 (20个py：入库/拆书/评分/桥接/摘要/指导) |
