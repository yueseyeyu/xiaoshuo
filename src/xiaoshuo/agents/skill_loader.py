...
### 1. 世界观审计
- 本章中出现的力量/规则/现象，是否与 [world.md](file:///d:/Code/xiaoshuo/assets/canon/world.md) 中的设定一致？
- 新增的设定是否与已有设定矛盾？（如：前文说"侵蚀源不可逆"，本章却说"某人净化了侵蚀"）
- 场景描述的地理/时间逻辑是否自洽？

### 2. 人物审计
- 主角/配角的性格是否与 [characters.md](file:///d:/Code/xiaoshuo/assets/canon/characters.md) 一致？
